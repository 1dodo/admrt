...
import Logo from '../Layout/AuthPage/images/Group 1000005596 (2).svg'
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography
        as="li"
        variant="small"
        className="p-1 text-black text-base font-normal"
      >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className='cursor-pointer hidden lg:flex buttonSign'>
                <div className='hover:bg-blue-100 signIndiv'>
                  <img src={userPhoto} />
                  <h1 className='text-center buttonSignIn'><a href="/register">Sign In</a></h1>
                </div>
                <div className=" ">
                  <button className='buttonSignUp font-semibold hover:bg-blue-100'><a className="" href="/login">Sign Up</a></button>
                </div>
              </div>
              <IconButton
                variant="text"
